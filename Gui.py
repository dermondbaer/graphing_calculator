...
class Gui(object):
    def __init__(self, main, title):
        ...
        self.__lbl_err.grid(row=3, column=1, sticky="NESW")
        self.__lbl_err_info.grid(row=3, column=0, sticky="NES")
        ...
        self.__mathbtn.grid(row=1, column=0, columnspan=2, padx=self.__pad_general, pady=self.__pad_general,
                            sticky="NESW")
        self.__btn_pi = Button(master=self.__mathbtn, text="PI", command=partial(self.press, "pi")).grid(row=0,
                                                                                                         column=0,
                                                                                                         sticky="NESW")
        self.__btn_e = Button(master=self.__mathbtn, text="e", command=partial(self.press, "e")).grid(row=0, column=1,
                                                                                                      sticky="NESW")
        self.__btn_x = Button(master=self.__mathbtn, text="x", command=partial(self.press, "x")).grid(row=0, column=2,
                                                                                                      sticky="NESW")
        self.__btn_sqrt = Button(master=self.__mathbtn, text="sqrt()", command=partial(self.press, "sqrt ( ")).grid(row=0,
                                                                                                                  column=3,
                                                                                                                  sticky="NESW")
        self.__btn_root = Button(master=self.__mathbtn, text="root()", command=partial(self.press, "root ( ")).grid(
            row=0,
            column=4,
            sticky="NESW")
        self.__btn_log = Button(master=self.__mathbtn, text="log()", command=partial(self.press, "log ( ")).grid(row=0,
                                                                                                                column=5,
                                                                                                                sticky="NESW")
        # second row
        self.__btn_sin = Button(master=self.__mathbtn, text="sin()", command=partial(self.press, "sin ( ")).grid(row=1,
                                                                                                                column=0,
                                                                                                                sticky="NESW")
        self.__btn_cos = Button(master=self.__mathbtn, text="cos()", command=partial(self.press, "cos ( ")).grid(row=1,
                                                                                                                column=1,
                                                                                                                sticky="NESW")
        self.__btn_tan = Button(master=self.__mathbtn, text="tan()", command=partial(self.press, "tan ( ")).grid(row=1,
                                                                                                                column=2,
                                                                                                                sticky="NESW")
        self.__btn_max = Button(master=self.__mathbtn, text="max()", command=partial(self.press, "max ( ")).grid(row=1,
                                                                                                                column=3,
                                                                                                                sticky="NESW")
        self.__btn_opbr = Button(master=self.__mathbtn, text="(", command=partial(self.press, " ( ")).grid(row=1,
                                                                                                           column=4,
                                                                                                           sticky="NESW")
        self.__btn_clbr = Button(master=self.__mathbtn, text=")", command=partial(self.press, " ) ")).grid(row=1,
                                                                                                           column=5,
                                                                                                           sticky="NESW")
    ...
    def press(self, value):
        if self.is_numeral(value):
            self.__parse_expr += value
        else:
            self.__parse_expr += value
        self.__lbl_parse_expr.configure(text=self.__parse_expr)
    ...
    def equals(self):
        try:
            tmp = self.__parser.make_expression_postfix(self.__parse_expr)
