...
class Gui(object):
    ...
    def __init__(self, master, target_size_x=1000, target_size_y=1000, default_units_x=10, default_units_y=10):
        """
        :arg master: The parent tkinter element of this Gui.
        ...
        # Binding keys to important functionalities of this Gui.
        ...
        # Calculating the scale of this Gui.
        ...
        # Calculating the absolute size of the CoordinateSystem im pixels.
        ...
        # Creating the actual CoordinateSystem.
        self.__coordinate_system = CoordinateSystem(self, self.__frame, absolute_size)

    def start(self):
        """Calls the mainloop for this Gui."""
        self.__master.mainloop()

    def restart(self, resize=True):
        """Destroys the CoordinateSystem and asks the user to enter the size of the CoordinateSystem,
        that is then being recreated. Previously existent figures are being redrawn."""
        ...
        # Recalculating the scale and the absolute size of the CoordinateSystem.
        neg_units_x, pos_units_x = units_x
        neg_units_y, pos_units_y = units_y
        scale_x = target_size_x / (abs(neg_units_x) + abs(pos_units_x))
        scale_y = target_size_y / (abs(neg_units_y) + abs(pos_units_y))
    ...
    def get_master(self):
        """Returns the parent tkinter element of this Gui."""
        return self.__master

    def get_frame(self):
        """Returns the main frame of this Gui."""
        return self.__frame

    def create_point(self, coordinates, debug_output=False):
        """Creates a point in the CoordinateSystem at the given coordinates."""
    ...
    def create_distance(self, coord_a, coord_b, debug_output=False):
        """Creates a distance in the CoordinateSystem from point a to point b."""
    ...
    def create_function_graph(self, function_term, debug_output=False):
        """Creates a function graph in the CoordinateSystem."""
        if debug_output:
